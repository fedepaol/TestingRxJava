...
import com.whiterabbit.rxjavatesting.inject.MockApplicationModule;

public class TestRobolectricApplication extends MyApplication {
    private ApplicationModule mApplicationModule;

    @Override
    ApplicationModule getApplicationModule() {
        return new MockApplicationModule();
    }
}
